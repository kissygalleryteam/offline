...
kg/offline/2.0.0/localstorage
kg/offline/2.0.0/ie-offline
 ...
 **/
KISSY.add('kg/offline/2.0.0/localstorage',function(S,Json) {
	var re = {},
 ...
 * @author 伯方<bofang.zxj@taobao.com>
 **/
KISSY.add('kg/offline/2.0.0/ie-offline',function(S,Json) {
	var re = {},
		doc = document,
 ...
 * @author 伯方<bofang.zxj@taobao.com>
 **/
KISSY.add('kg/offline/2.0.0/index',function(S, LocalStorage, IeOffline,Base) {
