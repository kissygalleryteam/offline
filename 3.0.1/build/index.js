...
kg/offline/3.0.1/localstorage
kg/offline/3.0.1/ie-offline
kg/offline/3.0.1/index
 ...
 **/
KISSY.add('kg/offline/3.0.1/localstorage',function(S,Json) {
	var re = {},
 ...
 * @author 伯方<bofang.zxj@taobao.com>
 **/
KISSY.add('kg/offline/3.0.1/ie-offline',function(S,Json) {
	var re = {},
		doc = document,
	...
	S.mix(re, {
		...
		usedByte: function() {
			var tempLen = 0,
				strDeadLine = Json.stringify(oDeadline);
			//deadline不存在
			if(oDeadline !== '') {
 ...
 * @author 伯方<bofang.zxj@taobao.com>
 **/
KISSY.add('kg/offline/3.0.1/index',function(S, LocalStorage, IeOffline,Base) {
